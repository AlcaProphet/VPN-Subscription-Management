...
- **状态：** ✅ R32-02 工程修复、自动化门禁与本地隔离 smoke 已完成（2026-09-17）；☐ PT-R32-02-01～05 正式 SMTP、真实收件箱、浏览器邮件日志页与外部客户端人工核验仍按 [ProdTestList.md](ProdTestList.md) 跟踪，不属于 `TODOLIST.md` 的短期待办。
