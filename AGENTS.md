...
| [Issue18.md](Issue18.md) | AI 编码助手 / 开发者 | R32-01 有效站点名称一致性修复；R32-02 业务邮件异步派发、短期发送日志、全路径迁移与生命周期 | 已闭环（根目录保留；R32-02 构建记录见 Build29） |
