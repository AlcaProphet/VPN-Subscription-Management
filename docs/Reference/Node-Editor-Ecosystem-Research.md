...
- 【项目事实】`BuildReport4.md` 列出 N-node-1～N-node-6 等节点输出/诊断缺口；其中 N-node-1/2/3/4/5 已由 Build21 处理，N-node-6 及 Build16/Design3 D3 等遗留登记在 [Issue14.md](../reports/Issue/Issue14.md)。
