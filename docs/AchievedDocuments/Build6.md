...
- ◧ Step 5：流量采集、配额检查、超限摘除与重置配额（Issue3 R17-06 测试缺口未闭环，待复验）
- ◧ Step 6：假 Xray 服务集成测试与 Build6 端到端验收（Issue3 R17-06 测试缺口未闭环，待复验）
...
| 5 | 流量采集与配额 | Design2 §5.8 | ◧ 进行中（Issue3 R17-06 测试缺口未闭环） |
| 6 | 假 Xray 集成测试与验收 | Design2 第五章全量 | ◧ 进行中（Issue3 R17-06 测试缺口未闭环） |
