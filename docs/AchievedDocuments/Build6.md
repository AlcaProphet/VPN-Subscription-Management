...
- ✅ Step 5：流量采集、配额检查、超限摘除与重置配额（Issue3 R16-01/07/08 已闭环，2026-08-21 恢复）
- ✅ Step 6：假 Xray 服务集成测试与 Build6 端到端验收（Issue3 R16-07/09 已闭环，2026-08-21 恢复）
...
| 5 | 流量采集与配额 | Design2 §5.8 | ✅ 验收通过（Issue3 R16-01/07/08 已闭环） |
| 6 | 假 Xray 集成测试与验收 | Design2 第五章全量 | ✅ 验收通过（Issue3 R16-07/09 已闭环） |
