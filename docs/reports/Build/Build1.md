...
| Step | 内容 | 设计依据 | 状态 |
|------|------|---------|------|
| 1 | 后端工程骨架与基础中间件 | Design1 §5.1/5.2/6.5 | ✅ 验收通过 |
| 2 | 前端工程骨架与测试基建 | Design1 §5.1/3.7，UI §一/七 | ✅ 验收通过 |
| 3 | Docker 多阶段构建与 Compose 模板 | Design1 §5.6/7.1 | ✅ 验收通过 |
| 4 | 本地认证闭环（注册/登录/会话/首管理员） | Design1 §3.2/4.6/5.4/2.5 | ✅ 验收通过 |
| 5 | Setup 首次配置引导 | Design1 §3.1/2.2/3.4.4 | ✅ 验收通过 |
| 6 | OIDC 认证与模拟 OIDC | Design1 §3.2/4.6/5.3 | ✅ 验收通过 |
| 7 | 密码重置、验证码与速率限制 | Design1 §3.2/4.6/6.1/3.4.8 | ✅ 验收通过 |
