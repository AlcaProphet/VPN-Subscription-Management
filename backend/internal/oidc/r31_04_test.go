...
func TestR3104StartFlowRejectsDamageBeforeNetwork(t *testing.T) {
	...
	rec := &StateRecord{ProviderType: "generic", ConfigHash: providerConfigHash("generic", rawParams("https://idp.example.com", "", "c", "any-cipher")), CodeVerifier: "verifier", Nonce: "nonce"}
	before = atomic.LoadInt32(&hits)
