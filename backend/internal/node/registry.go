	...
	return []Protocol{
		...
		},
		{
			...
			FormSchema: []FieldSchema{
				...
				{Name: "alpn", Type: "text", Label: "ALPN"},
				{Name: "client-fingerprint", Type: "text", Label: "指纹"},
				{Name: "public-key", Type: "text", Label: "REALITY 公钥"},
				{Name: "private-key", Type: "password", Label: "REALITY 私钥"},
				{Name: "short-id", Type: "text", Label: "REALITY ShortId"},
				{Name: "udp", Type: "bool", Default: true, Label: "UDP"},
			},
			SensitiveFields: []string{"uuid", "private-key"},
			LinkMappings:    LinkMapping{SR: true, Generic: true, Params: []string{"uuid", "flow", "network", "tls", "servername", "alpn", "client-fingerprint", "public-key", "private-key", "short-id"}},
		},
		{
