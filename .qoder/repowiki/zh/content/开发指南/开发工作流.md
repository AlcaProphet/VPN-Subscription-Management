...
**变更内容**
- 更新了AI编码指导原则和设计文档体系
- 明确了当前最新设计文档为Design2.md和Design2-UI.md
- 增强了AI辅助开发工作流的指导规范
- 更新了文档优先级和执行规则
- 强化了构建验证和测试要求
...
- **文档体系**：采用分层文档结构，AGENTS.md为强要求文档，Design2.md和Design2-UI.md为当前最新设计文档。
...
J --> K["设计文档<br/>Design2.md/Design2-UI.md"]
```
...
- [AGENTS.md:178-225](file://AGENTS.md#L178-L225)
...
- [Dockerfile:1-31](file://Dockerfile#L1-L31)
- [.github/workflows/docker-build.yml:1-53](file://.github/workflows/docker-build.yml#L1-L53)
- [AGENTS.md:18-52](file://AGENTS.md#L18-L52)
...
- [AGENTS.md:55-87](file://AGENTS.md#L55-L87)
...
- [AGENTS.md:66-77](file://AGENTS.md#L66-L77)
...
- [AGENTS.md:71-77](file://AGENTS.md#L71-L77)

### AI辅助开发工作流
**新增** 基于AGENTS.md的AI辅助开发规范：

- **文档优先级**：AGENTS.md > Design > Build > Issue
- **当前设计文档**：Design2.md（增量能力设计）和 Design2-UI.md（GUI规格）
- **AI行为准则**：
  - 不确定时必须提问，禁止自行决策
  - 无明确指令不得自行改动
  - 构建前必须检查疑点
...
subgraph "AI辅助"
AI["AGENTS.md指导"]
DESIGN["Design2.md/Design2-UI.md"]
end
FE --> |"构建产物"| BE
BE --> |"嵌入/服务"| RUN
AI --> FE
...
- [AGENTS.md:20-31](file://AGENTS.md#L20-L31)
...
- [frontend/vite.config.ts:8-14](file://frontend/vite.config.ts#L8-L14)
- [AGENTS.md:57-70](file://AGENTS.md#L57-L70)
...
- [frontend/package.json:6-11](file://frontend/package.json#L6-L11)
- [.smoke-test.sh:1-73](file://.smoke-test.sh#L1-L73)
- [AGENTS.md:152-164](file://AGENTS.md#L152-L164)