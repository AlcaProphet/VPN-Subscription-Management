...
## 更新摘要
**所做更改**
- 更新了文档位置以反映知识库重构，从内部wiki结构移动到项目根目录
- 保持了完整的后端架构设计内容和技术细节
- 增强了源代码引用和依赖关系分析
- 优化了架构图和流程图的可读性
...
- [ratelimit.go:27-88](file://backend/internal/ratelimit/ratelimit.go#L27-88)
- [response.go:14-50](file://backend/internal/response/response.go#L14-50)
