...
## 更新摘要
**变更内容**
- Go 版本升级至 1.26，支持 Xray-core 集成
- 新增配额执行和预检查机制
- 增强 Xray API 调用错误处理
- Xray API 调用并发控制（串行执行）
- 全面的审计跟踪日志记录
...
**更新** 本项目已升级至 Go 1.26，支持 Xray-core 集成，新增配额管理、预检查机制和增强的错误处理能力。
...
**更新** 新增的 Xray 集成功能为用户配额管理和流量统计提供了强大的支持，提升了系统的管理能力。
