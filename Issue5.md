...
3. **R20-15**：Build6/Build7 各 Step 勾选状态与 AGENTS 归档/文档索引如何定稿？
4. **R20-25**：Design2-UI 是否按 Issue4 R19-02/R19-08 回写（代码已按 Issue4 执行，仅设计文档更新时机需确认）？
5. **R20-27**：独立账号编辑凭据变更后是否应重推全部保留目标，还是改为“创建后凭据不可改”？
6. 其余 R20-01~07/09~14/16~24/26 均为确定性问题，建议按上述方案修复。
