...
- **状态：** ◧ 工程修复完成（含两轮核验发现的阻塞/边界项）；后端 build/vet/test、errgate 与前端 build/test 通过；真实 OIDC 登录与 Issue17 遗留项仍需隔离环境/单独处理。
...
4. R30-05 工程修复已完成，真实 OIDC 登录待用户提供隔离环境单独核验；原 R30-07「暂未启用」未落库问题已迁入 [Issue17.md](Issue17.md)，现编号为 R31-07。
