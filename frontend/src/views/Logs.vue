  ...
  <div>
    <div class="flex justify-between items-center mb-5 flex-wrap gap-3">
      ...
      <input
        ...
        class="rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 py-2 text-base text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
      />
    </div>
